...
const translations = {
  en: {
    ...
    "scheduling.contactLink": "Reach us directly at admin@quantico.gt",
    "scheduling.contact.orForm": "Or submit a form",
    "scheduling.contact.formButton": "Go to contact form",
    ...
    "scheduling.form.title": "Confirm your details",
    "scheduling.form.name": "Full name",
    "scheduling.form.namePlaceholder": "Jane Doe",
    "scheduling.form.email": "Email address",
    "scheduling.form.emailPlaceholder": "jane@example.com",
    "scheduling.form.notes": "What's on your mind? (optional)",
    "scheduling.form.notesPlaceholder": "Tell us a bit about your project...",
    "scheduling.form.submit": "Confirm booking",
    "scheduling.form.submitting": "Booking…",
    "scheduling.form.errorFields": "Please fill out all required fields.",
    "scheduling.form.errorCaptcha": "Please complete the captcha.",
    "scheduling.form.errorTaken": "That time was just booked by someone else. Please pick another one.",
    "scheduling.form.errorGeneric": "Something went wrong. Please try again.",
    "scheduling.form.errorCooldown": "Please wait a moment before booking again.",
    "scheduling.success.title": "You're booked!",
    "scheduling.success.body": "A calendar invite is on its way to your inbox.",
    "scheduling.success.meetLink": "Join with Google Meet",
  ...
  es: {
    ...
    "scheduling.contactLink": "Escríbenos directamente a admin@quantico.gt",
    "scheduling.contact.orForm": "O envía un formulario",
    "scheduling.contact.formButton": "Ir al formulario de contacto",
    ...
    "scheduling.form.title": "Confirma tus datos",
    "scheduling.form.name": "Nombre completo",
    "scheduling.form.namePlaceholder": "Jane Doe",
    "scheduling.form.email": "Correo electrónico",
    "scheduling.form.emailPlaceholder": "jane@example.com",
    "scheduling.form.notes": "¿Qué tienes en mente? (opcional)",
    "scheduling.form.notesPlaceholder": "Cuéntanos un poco sobre tu proyecto...",
    "scheduling.form.submit": "Confirmar reserva",
    "scheduling.form.submitting": "Reservando…",
    "scheduling.form.errorFields": "Por favor completa todos los campos requeridos.",
    "scheduling.form.errorCaptcha": "Por favor completa el captcha.",
    "scheduling.form.errorTaken": "Ese horario acaba de ser reservado por alguien más. Elige otro.",
    "scheduling.form.errorGeneric": "Algo salió mal. Por favor intenta de nuevo.",
    "scheduling.form.errorCooldown": "Espera un momento antes de reservar de nuevo.",
    "scheduling.success.title": "¡Reserva confirmada!",
    "scheduling.success.body": "Recibirás una invitación de calendario en tu correo.",
    "scheduling.success.meetLink": "Unirse con Google Meet",
